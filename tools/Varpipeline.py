...
class snp():
    ...
    def __processAlignment(self):
        ...
        if (self.__ranBWA):
            ...
            self.__CallCommand('SamFormatConverter', ['gatk', 'SamFormatConverter', '-INPUT', self.__alnSam, '-VALIDATION_STRINGENCY', 'LENIENT', '-OUTPUT', GATKdir +'/GATK.bam', ])
        else:
        ...
        self.__CallCommand('SortSam', ['gatk', 'SortSam',  
        ...
        self.__CallCommand('MarkDuplicates', ['gatk', 'MarkDuplicates',  
    ...
    def runGATK(self):
        if os.path.isfile(self.__finalBam):
            ...
            self.__CallCommand('LeftAlignAndTrimVariants', ['gatk', 'LeftAlignAndTrimVariants', 
